...
const ProblemInventory = () => {
  ...
  if (loading) {
    return (
      <Layout>
        <div className="h-screen flex items-center justify-center bg-[#0f172a] text-ucla-gold font-black italic">
          SYNCING INVENTORY...
        </div>
      </Layout>
    );
    ...
    <Layout>
      <div className="max-w-7xl mx-auto px-4 pb-12 pt-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="lg:col-span-2 bg-[#020617] rounded-[2.5rem] p-8 border border-slate-800 shadow-inner">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="group relative cursor-pointer">
                <Info size={16} className="text-slate-600 group-hover:text-ucla-gold transition-colors" />
        ...
        <div className="bg-white dark:bg-[#1a2236] p-4 rounded-3xl shadow-2xl border border-slate-100 dark:border-slate-800 mb-8 flex flex-wrap gap-4 items-center">
          ...
          <div className="flex gap-3 flex-wrap">
            <select
              ...
              className="bg-slate-100 dark:bg-slate-900 px-5 py-3 rounded-2xl text-[10px] font-black uppercase outline-none cursor-pointer hover:bg-slate-200 transition-colors"
            >
            ...
            <select
              ...
              className="bg-slate-100 dark:bg-slate-900 px-5 py-3 rounded-2xl text-[10px] font-black uppercase outline-none"
            >
        ...
        <div className="bg-white dark:bg-[#0f172a] rounded-[2.5rem] border border-slate-100 dark:border-slate-800 overflow-hidden shadow-2xl">
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800/50">
              {filtered.map(problem => (
                <tr
                  ...
                  className="hover:bg-ucla-blue/[0.03] transition-all cursor-pointer group"
                >
                  <td className="px-10 py-3">
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex gap-2 mt-2">
                        <span className="text-[9px] font-black px-2.5 py-1 bg-ucla-gold/10 text-ucla-gold rounded-lg border border-ucla-gold/10 uppercase">
                          Lvl {problem.quality || '?'}
                        </span>
                        {(problem.topics || []).map(t => (
                          <span
                            key={t}
                            className="text-[9px] font-black px-2.5 py-1 bg-ucla-blue/5 text-ucla-blue rounded-lg border border-ucla-blue/10 uppercase tracking-tighter"
                          >
                            {t}
                          </span>
                        ))}
          ...
          {filtered.length === 0 && (
            <div className="py-24 text-center">
              ...
              <p className="text-slate-500 font-bold italic tracking-tight text-lg">
